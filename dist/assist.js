  ...
  */
  ...
  var Audio = {
    init: function init(core) {
      ...
      this.AudioApi = ((CONFIG === null || CONFIG === void 0 ? void 0 : CONFIG.backend) || url) + '/uaa/api/ua/speech';
    ...
    showAudio: function showAudio() {
      ...
      this.audioTabImg.src = this.audioTabImg.getAttribute('source-src'); // this.pointeReadTabIcon.src = this.pointeReadTabIcon.getAttribute('source-src')
    },
    closeAudio: function closeAudio() {
      ...
      this.audioTabImg.src = this.audioTabImg.getAttribute('selected-src'); // this.pointeReadTabIcon.src = this.pointeReadTabIcon.getAttribute('source-src')
    },
